...
#altered: from party_identification.extracting_parties import extract_parties
from party_identification.extracting_parties_altered import extract_parties
...
class Conflict_finder:
    ...
    def __init__(self, similarityChecker, stanfordCoreNLP):
    ...
    def extract_entities(self, *path):
        ...
        self.entities, self.nicknames = extract_parties(self.path, self.scnlp)
                ...
                for j in range(len(norm)):
                    if j > i:
                        ...
                        if label:
                            ...
                            result = self.similarityChecker.similarityED(norm1, norm2)
